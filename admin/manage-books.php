...
<img src="bookimg/<?php echo htmlentities($result->bookImage);?>" width="100">
                                            ...
                                            <a href="edit-book.php?bookid=<?php echo htmlentities($result->bookid);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Thay đổi</button> 
                                          <a href="manage-books.php?del=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Chắc cahwns xóa?');" >  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Xóa</button>
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
