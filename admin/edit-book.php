...
<head>
    ...
    <title>Quản lý thư viện | Thay đổi sách</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Thay đổi sách</h4>
...
<a href="change-bookimg.php?bookid=<?php echo htmlentities($result->bookid);?>">Thay đổi ảnh bìa/a>
</div></div>
...
<div class="col-md-6">
<div class="form-group">
<label> Loại sách<span style="color:red;">*</span></label>
...
<div class="col-md-6">
<div class="form-group">
<label>Mã số ISBN<span style="color:red;">*</span></label>
<input class="form-control" type="text" name="isbn" value="<?php echo htmlentities($result->ISBNNumber);?>"  readonly />
<p class="help-block">ISBN là mã số sách tiêu chuẩn quốc tế. ISBN là duy nhất</p>
</div></div>
...
<button type="submit" name="update" class="btn btn-info">Thay đổi</button></div>
