...
$bookid=$_POST['bookid'];
$isissued=1;
$sql="INSERT INTO  tblissuedbookdetails(ReaderID,BookId) VALUES(:readerid,:bookid);
...
<head>
    ...
    <title>Quản lý thư viện | Thêm mới phiếu mượn</title>
...
<input class="form-control" type="text" name="readerid" id="readerid" onBlur="getreader()" autocomplete="off"  required />
</div>
...
<div class="form-group">
<label>Mã số ISBN hoặc tên sách<span style="color:red;">*</span></label>
...
<button type="submit" name="issue" id="submit" class="btn btn-info">Thêm mới </button>
